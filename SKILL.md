    ...
    27|- **Previous role**: System Administrator / Change Analyst at [YOUR_PREVIOUS_COMPANY] (Sept 2022 – March 2026) — managed Windows Server environments, ITIL/ITSM change management, ~20 server builds/month, CAB meetings, SOPs
    ...
    35|- **Portfolio**: [YOUR_PORTFOLIO_URL]
    36|- **OnlineJobs.ph profile**: [YOUR_OJ_PROFILE_URL]
    37|- **Upwork**: [YOUR_UPWORK_PROFILE]
    38|- **LinkedIn**: [YOUR_LINKEDIN]
    39|
    ...
    72|- **Target Google Sheet ID**: `[YOUR_GOOGLE_SHEET_ID]`
   ...
   187|- **Always append** ` — [YOUR_NAME]` at the end of the subject UNLESS the job description specifies a required subject line (e.g., "Include [word] in your subject" or "Subject must be..."). When a required subject is specified, use it exactly as instructed without adding the name.
   188|- Examples:
   189|  - `"n8n Automation Expert for Your Workflow Needs — [YOUR_NAME]"`
   190|  - `"AI Automation Specialist — Make.com & Zapier — [YOUR_NAME]"`
   191|  - `"Your Next Automation Specialist is Here — [YOUR_NAME]"`
   192|
   ...
   217|- **Always append** ` — [YOUR_NAME]` at the end of the subject UNLESS the job description specifies a required subject line (e.g., "Include [word] in your subject" or "Subject must be..."). When a required subject is specified, use it exactly as instructed without adding the name.
   218|- Examples:
   219|  - `"n8n Automation Expert for Your Workflow Needs — [YOUR_NAME]"`
   220|  - `"AI Automation Specialist — Make.com & Zapier — [YOUR_NAME]"`
   221|  - `"Your Next Automation Specialist is Here — [YOUR_NAME]"`
   222|
   223|#### Message rules:
   ...
   230|  - If they ask for "portfolio samples" → link [YOUR_PORTFOLIO_URL] and add **[📎 ATTACH: Portfolio samples / case studies]**
   ...
   301|🔗 Sheet: https://docs.google.com/spreadsheets/d/[YOUR_GOOGLE_SHEET_ID]
   302|
   ...
   397|
   398|4. **Generic proposals.** Every proposal must reference specific portfolio projects or [your previous company] experience with metrics. No filler like "I am a hard worker."
   399|
